...
QUALITY_TIERS: dict[str, QualityTier] = {
    ...
    "Rare": {"code": "r", "color": "blue", "skill_min": 30, "skill_max": 40, "cash_min": 500, "cash_max": 1000},
    "Epic": {"code": "e", "color": "purple", "skill_min": 50, "skill_max": 60, "cash_min": 1000, "cash_max": 4000}
}
...
EVENT_NARRATION_TEMPLATES: dict[str, list[str]] = {
    ...
    "wander_group": [
        "While traveling through {leg_vibe}, {hero_name} fell in with a wandering group that knew a shortcut.",
        ...
        "While crossing {leg_vibe}, {hero_name} let a wandering group hustle the journey forward.",
    ],
    "fairy_found": [
...
OUTCOME_TEXT: dict[str, str] = {
    ...
    "wander_group": "The wandering group helped you cover extra ground.",
