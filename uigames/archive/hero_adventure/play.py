...
class HeroAdventureTUI(App):
    ...
    async def _mount_text(self, parent, control, title=False, outcome=False):
    ...
    async def _mount_regular_control(self, parent, control):
        ...
        if control_type == "text":
            await self._mount_text(
                parent,
                control,
                title=control.get("variant") == "title",
                outcome=control.get("variant") == "outcome",
            )
